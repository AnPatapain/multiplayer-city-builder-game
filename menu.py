...
class Menu:
    def __init__(self, screen, clock):
        ...
        self.button__start_new_career = button.Button("Start new career", (button_start, 350), button_size, center=True)
        self.button__start_new_career.on_click(self.set_inactive)

        self.button__load_saved_game = button.Button("Load saved game", (button_start, 400), button_size, center=True)

        self.button__options = button.Button("Options", (button_start, 450), button_size, center=True)

        self.button__exit = button.Button("Exit", (button_start, 500), button_size, center=True)
